...
CROCO_MODELS_PATH="/home/rupal/Master-Thesis-Project/Experiments/dust3r_experiments/dust3r/croco/models"

# print(CROCO_REPO_PATH)
# check the presence of models directory in repo to be sure its cloned
if path.isdir(CROCO_MODELS_PATH):
    # workaround for sibling import
    sys.path.insert(0, "/home/rupal/Master-Thesis-Project/Experiments/dust3r_experiments/dust3r/croco")
else:
